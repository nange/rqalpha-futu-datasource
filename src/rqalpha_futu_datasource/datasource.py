...
class FutuDataSource:
    ...
    def get_bar(self, symbol: str, dt: datetime.datetime, frequency: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_bars(self, symbol: str, start_dt: datetime.datetime, 
                end_dt: datetime.datetime, frequency: str) -> List[Dict[str, Any]]:
        """
